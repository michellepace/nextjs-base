...
Install local docs for AI coding agents:

```bash
# Next.js — downloads version-matched docs to .next-docs/ and injects index into AGENTS.md
npx @next/codemod@latest agents-md

# HeroUI v3 — downloads component docs to .heroui-docs/react/ and generates AGENTS.md
...
| :--- | :--- | :--- |
| Baseline (no docs) | 53% | — |
| Skill (default behaviour) | 53% | +0pp |
...
| :--- | :--- | :--- | :--- |
| Baseline | 84% | 95% | 63% |
| Skill (default behaviour) | 84% | 89% | 58% |
...
![The full compressed docs index. Each line maps a directory path to the doc files it contains](https://vercel.com/vc-ap-vercel-marketing/_next/image?url=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fcontentful%2Fimage%2Fe5382hct74si%2F7FuC0523TmDXUKhQNe8pAB%2F9060456f97c3863cb3b35a6404ca17a1%2Fimage_6_.png&w=1920&q=75)
